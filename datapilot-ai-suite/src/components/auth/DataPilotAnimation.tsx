/**
 * DataPilotAnimation
 * Lightweight, dependency-free SVG/CSS animation:
 * spreadsheet cells -> data points flowing -> AI node processing -> chart forms -> insight badge.
 * All keyframes live in the global stylesheet (see `dp-*` animations).
 */
